...
```
cd existing_repo
git remote add origin https://ci.tno.nl/gitlab/tke/knowledge-engine-sparql-endpoint.git
git branch -M main
...
- [ ] [Set up project integrations](https://ci.tno.nl/gitlab/tke/knowledge-engine-sparql-endpoint/-/settings/integrations)
